...
echo "4. Kiểm tra database: cd emlinh_mng && source venv/bin/activate && python -c 'from src.app.app import create_app; from src.app.models import db; app, _ = create_app(); app.app_context().push(); db.create_all()'"
echo ""
